            ...
            <div class="row"> 
                <div class="col-sm-offset-1 col-sm-10 col-xs-12 ">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        ...
                        <p><strong>Last Name:</strong> Huluban</p>
                        <p><strong>Company Name:</strong> Healthysoft</p>
                    </div>
                    <div class="col-sm-6 col-xs-12">
                        <p><strong>Company Address:</strong> Cluj Napoca</p>
                        <p><strong>Company Phone:</strong> 07454545453</p>
                        <p><strong>Email Address:</strong> daniel@huluban.com</p>
                    </div>
                    <h2 class="subtitle"><@spring.message 'USER.DETAILS.SUBSCRIPTION.TITLE'/></h2>
                    <div class="separator-line"></div> 
                    <div class="col-sm-12">
                        <h4><strong>Active subscriptions</strong></h4>
                        <ul class="style-list">
                    ...
                    <div class="inactive-section">                   
                        <a data-toggle="collapse" href="#inactive"><@spring.message 'USER.DETAILS.INACTIVE.SUBSCRIPTION'/></a>
                        <ul id="inactive" class="style-list collapse">
                            <@createSubscriptionSection isInactive=true/>
                            <@createSubscriptionSection isInactive=true/>
                    </div>
                    <h2 class="subtitle"><@spring.message 'USER.DETAILS.ORDERS.TITLE'/></h2>
                    <div class="separator-line"></div> 
                    <div class="orders">
                        <a class="view-all-orders"><@spring.message 'USER.DETAILS.ALL.ORDERS'/></a>
                        <ul class="order-list">
                           <@createOrderSection />   
                           <@createOrderSection />                 
                        </ul> 
                    ...
                    <div class="separator-line"></div>  
                    <div class="invoices">
                        <a id="all-orders" class="view-all-invoices"><@spring.message 'USER.DETAILS.ALL.INVOICES'/></a>
...
<#macro createSubscriptionSection isInactive=false >
    <li>
        <div class="active-mark-section <#if isInactive> inactive-mark-section</#if> col-sm-6">
...
<#macro createOrderSection>
    <li>
        <div class="order">
            <a><div class="btn form-btn blue go-right"><@spring.message 'ORDERS.DETAILS.VIEW.BUTTON'/></div></a>
...
<#macro createInvoiceSection>
    <li>
        <div class="row invoice-details">
            ...
            <div class="col-sm-2 col-xs-6">
                <a><div class="btn form-btn blue go-right"><@spring.message 'USER.DETAILS.INVOICE.VIEW.BUTTON'/></div></a>
            </div>
        </div>
    </li> 
</#macro>
