<#if order??>
  <section class="content-header">
	...
	<ol class="breadcrumb">
	  ...
	  <li>
	    <a href="/market-time/orders">
	      <@spring.message 'ORDERS.NAV.PAGE'/>
	    </a>
	  </li>
  ...
  <section class="content">
	<div class="box box-success">
	  <div class="box-header with-border"></div>
	    <div id="order-details-id" class="row-style row">
	      <a href="/market-time/orders"><< <@spring.message 'ORDER.DETAILS.NAV.BACK'/></a>
			...
			<div class="row">
	            ...
	            <div class="ship-details col-sm-6">
	              <#if shippingInfo.firstName??>
	                <p><strong><@spring.message 'ORDER.DETAILS.SHIPPING.FIRST.NAME.LABLE'/>:</strong> ${shippingInfo.firstName}</p>
		          </#if>
                  <#if shippingInfo.lastName??>
	                <p><strong><@spring.message 'ORDER.DETAILS.SHIPPING.LAST.NAME.LABLE'/>:</strong> ${shippingInfo.lastName}</p>
		          </#if>
                  <#if shippingInfo.address??>
	                <p><strong><@spring.message 'ORDER.DETAILS.SHIPPING.ADDRESS.LABLE'/>:</strong> ${shippingInfo.address}</p>
	              </#if>
                  <#if shippingInfo.email??>
	                <p><strong><@spring.message 'ORDER.DETAILS.SHIPPING.EMAIL.LABLE'/>:</strong> ${shippingInfo.email}</p>
	              </#if>

	                <p><strong><@spring.message 'ORDER.DETAILS.SHIPPING.COUNTRY.LABLE'/>:</strong> HARCODED</p>
	              
                </div>
                <div class="ship-details col-sm-6">
	              
	                <p><strong><@spring.message 'ORDER.DETAILS.SHIPPING.STATE.LABLE'/>:</strong> HARDCODED</p>
		          
		          
	                <p><strong><@spring.message 'ORDER.DETAILS.SHIPPING.CITY.LABLE'/>:</strong> HARDCODED</p>
		          
		          
	                <p><strong><@spring.message 'ORDER.DETAILS.SHIPPING.POSTAL.CODE.LABLE'/>:</strong> HARDCODED</p>
	                
                  <#if shippingInfo.phoneNumber??>
	                <p><strong><@spring.message 'ORDER.DETAILS.SHIPPING.PHONE.LABLE'/>:</strong> ${shippingInfo.phoneNumber}</p>
                  </#if>
                </div>
              </div>  
            </#if>   
	          ...
	          <div class="tab-content">
	              ...
	              <div class="action-details">
	                ...
	                <form>
	                  ...
	                  <div class="dropdown-select">
	                    ...
	                    <a class="cancel-form"><@spring.message 'ORDER.DETAILS.ACTION.SHIP.CANCEL.LINK.NAME'/></a>
	                </form>
	              </div>
	            </div>
	            ...
	            <div id="refund_order" class="tab-pane fade">
	              <div class="action-details">
	                ...
	                <br>
	                <form>
	                  <label><@spring.message 'ORDER.DETAILS.ACTION.REFUND.LABLE'/> *</label>
	                  <div class="dropdown-select">
	                    <select name="refund reasons">
	                      ...
	                      <option value="2"><@spring.message 'ORDER.DETAILS.ACTION.REFUND.REASON.ENABLE.FULFILL'/></option>
	                      <option value="3"><@spring.message 'ORDER.DETAILS.ACTION.REFUND.REASON.ORDER.SISTEM'/></option>
	                    </select>
	                  </div>
	                    ...
	                    <a class="cancel-form"><@spring.message 'ORDER.DETAILS.ACTION.REFUND.CANCEL.LINK.NAME'/></a>
	                </form>
	              </div>
	            </div>
	                  ...
	                  <div class="row">
	                    <div class="edit-shipping-padding col-md-6 col-sm-12">
	                      <div class="form-group form-icon-poz">
	                        <label for="text"><@spring.message 'ORDER.DETAILS.SHIPPING.FIRST.NAME.LABLE'/></label>
	                      ...
	                      <div class="form-group form-icon-poz">
	                        <label for="text"><@spring.message 'ORDER.DETAILS.SHIPPING.LAST.NAME.LABLE'/></label>
	                      ...
	                      <div class="form-group form-icon-poz">
	                        <label for="text"><@spring.message 'ORDER.DETAILS.SHIPPING.ADDRESS.LABLE'/></label>
	                      ...
	                      <div class="form-group form-icon-poz">
	                        <label for="text"><@spring.message 'ORDER.DETAILS.SHIPPING.EMAIL.LABLE'/></label>
	                      ...
	                      <div class="form-group form-icon-poz">
	                        <label for="text"><@spring.message 'ORDER.DETAILS.SHIPPING.COUNTRY.LABLE'/></label>
	                    ...
	                    <div class="edit-shipping-padding col-md-6 col-sm-12">
	                      <div class="form-group form-icon-poz">
	                        <label for="text"><@spring.message 'ORDER.DETAILS.SHIPPING.STATE.LABLE'/></label>
	                      ...
	                      <div class="form-group form-icon-poz">
	                        <label for="text"><@spring.message 'ORDER.DETAILS.SHIPPING.CITY.LABLE'/></label>
	                      ...
	                      <div class="form-group form-icon-poz">
	                        <label for="text"><@spring.message 'ORDER.DETAILS.SHIPPING.POSTAL.CODE.LABLE'/></label>
	                      ...
	                      <div class="form-group form-icon-poz">
	                        <label for="text"><@spring.message 'ORDER.DETAILS.SHIPPING.PHONE.LABLE'/></label>
	                      ...
	                      <div class="edit-shipping-button-padding col-md-12 col-sm-12">
	                        ...
	                        <a class="cancel-form"><@spring.message 'ORDER.DETAILS.ACTION.EDIT.SHIPPING.CANCEL.LINK.NAME'/></a>
	                      </div>
	                    </div>
	                </form>
	              </div>
