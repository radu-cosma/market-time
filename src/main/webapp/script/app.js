...
function _init() {
  ...
  $.MarketTime.layout = {
    ...
    fix: function () {
      ...
      var neg = $('#header-container').outerHeight() + $('#footer-container').outerHeight();
      var window_height = $(window).height();
      var sidebar_height = $(".sidebar").height();
      //Set the min-height of the content and sidebar based on the
      //the height of the document.
      if ($("body").hasClass("fixed")) {
        $("#main-container, .right-side").css('min-height', window_height - $('#footer-container').outerHeight());
      } else {
        var postSetWidth;
        if (window_height >= sidebar_height) {
          $("#main-container, .right-side").css('min-height', window_height - neg);
          postSetWidth = window_height - neg;
        } else {
          $("#main-container, .right-side").css('min-height', sidebar_height);
        ...
        if (typeof controlSidebar !== "undefined") {
          if (controlSidebar.height() > postSetWidth)
            $("#main-container, .right-side").css('min-height', controlSidebar.height());
        }
  ...
  $.MarketTime.controlSidebar = {
    ...
    activate: function () {
      ...
      if ($('body').hasClass('fixed')) {
        ...
        if ($('#main-container, .right-side').height() < sidebar.height()) {
    ...
    _fixForContent: function (sidebar) {
      $("#main-container, .right-side").css('min-height', sidebar.height());
    }
  };
...
$('#btn-prev').on('click', function() {
    var $input =  $('#inp-prev-img');
    var $newImage = $('<img src="' + $input.val() + '" />');
     $('ul.preview').append($newImage);
     $input.val('');
});
